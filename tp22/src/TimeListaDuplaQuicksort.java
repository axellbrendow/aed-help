...
class ListaFlexDupla {
    ...
    public String toString()
    {
        ...
        for (CelulaDupla celula = primeiro; celula != null; celula = celula.prox)
        {
            if (celula.elemento != null)
            {
                apelido = celula.elemento.getApelido();

                if (apelido != null)
                {
                    str += apelido.length() <= 10 ?
